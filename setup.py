...
setup(name='pycasso',
      ...
      ext_modules=[Extension('pyc', ['sip/pyc.sip', 'src/Pycasso.cpp', 'src/Window.cpp', 'src/Layer.cpp', 'src/Layer2D.cpp', 'src/Font.cpp', 'src/EventQ.cpp', 'src/Layer2DOpenGL.cpp', 'src/WindowSDLOpenGL.cpp', 'src/EventQSDL.cpp', 'src/FontOpenGL.cpp'],
