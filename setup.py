...
setup(name='pycasso',
      ...
      ext_modules=[Extension('pyc', ['sip/pyc.sip', 'src/Pycasso.cpp', 'src/Window.cpp', 'src/Layer.cpp', 'src/EventQ.cpp', 'src/PycassoException.cpp', 'src/LayerOpenGL.cpp', 'src/WindowSDLOpenGL.cpp', 'src/EventQSDL.cpp'],
